                ...
                <div className="relative bg-white border-3 border-ink overflow-hidden">
                    ...
                    <div className="p-8 space-y-5">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-ink text-white border-3 border-ink font-bold text-base uppercase tracking-wide shadow-hard hover:bg-primary hover:text-ink hover:shadow-hard-hover hover:-translate-y-1 transition-all flex items-center justify-center gap-3"
                        >
